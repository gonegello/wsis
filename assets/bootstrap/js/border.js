  ...
  function stockBttm(){
    ...
    document.getElementById("u-i").style.color = "rgb(40,40,40)";
    document.getElementById("u-p").style.color = "rgb(40,40,40)";


    document.getElementById("s-i").style.fontSize = "35px";
    document.getElementById("s-p").style.fontSize = "13px";

    document.getElementById("c-i").style.fontSize = "16px";
    document.getElementById("c-p").style.fontSize = "16px";

    document.getElementById("u-i").style.fontSize = "16px";
    document.getElementById("u-p").style.fontSize = "16px";
  ...
  function catBttm(){
    ...
    document.getElementById("c-i").style.fontSize = "35px";
    document.getElementById("c-p").style.fontSize = "13px";

    document.getElementById("s-i").style.fontSize = "16px";
    document.getElementById("s-p").style.fontSize = "16px";
  ...
  function unitBttm(){
    ...
    document.getElementById("u-i").style.fontSize = "35px";
    document.getElementById("u-p").style.fontSize = "13px";
